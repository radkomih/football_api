RSpec.describe FootballApi::Coach do
  ...
  describe '.find' do
    ...
    it "requests the coachs endpoint with correct parameters" do
  ...
  describe '.all_by_team' do
    ...
    it "requests the coachs teams endpoint with correct parameters" do
  ...
  describe '.search' do
    ...
    it "requests the coachs endpoint by search term with correct parameters" do
