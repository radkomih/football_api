RSpec.describe FootballApi::Teams::Statistic do
  ...
  describe '.all_by_league_and_team' do
    ...
    it "requests the teams statistics by league and team endpoint" do
  ...
  describe '.all_by_league_and_team_and_date' do
    ...
    it "requests the teams statistics by league team and date endpoint" do
      expect(described_class.all_by_league_and_team_and_date(1, 10, '2019-02-10'))
        .to eq(response.dig('api', 'statistics'))
    end
  end
end
